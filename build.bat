...
set COMMON_LIBS= kernel32.lib user32.lib shell32.lib

if "%1" equ "release" (
    set COMPILE_FLAGS= /nologo /O1 /W4 /WX /Gm- /GR- /GS- /EHa- /Oi
    set LINK_FLAGS= /opt:ref /opt:icf /nodefaultlib /subsystem:windows %COMMON_LIBS% libvcruntime.lib
) else (
    set COMPILE_FLAGS= /nologo /Od /W4 /WX /MTd /Gm- /GR- /EHa- /Zo /Oi /Zi /FC
    set LINK_FLAGS= /opt:ref /incremental:no /Debug:full /nodefaultlib /subsystem:windows %COMMON_LIBS% libucrtd.lib libvcruntimed.lib
)
